...
// Generate a full recipe with calculated ingredients and nutrional value

    // Generate a recipe with raw data

    // Update recipe with ingredient and nutrional value

// Test method that execute one or more recipe
// Test method that execute one or more ingredient

// Find all possible ingredients from all recipes 

// Find all ingredients that do not have nutrional value
